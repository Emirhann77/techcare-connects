...
export interface Peer {
  id: string;
  /** Anonymous label shown before and during the session. */
  name: string;
  /** Real identity — revealed only after the session completes. */
  realName: string;
  role: string;

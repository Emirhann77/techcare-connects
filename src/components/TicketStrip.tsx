...
import { MAX_ACTIVE_TICKETS, type Ticket, type TicketUrgency } from "@/lib/mockData";
...
export default function TicketStrip({ tickets, onSelect }: TicketStripProps) {
    ...
    <div className="rounded-3xl border border-paper-300 bg-white/70 p-4">
      <div className="mb-3 flex items-center justify-between">
        <p className="uppercase-label flex items-center gap-2 text-stone-400">
          ...
          Tickets assigned to you · help a colleague
        </p>
